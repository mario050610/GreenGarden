...
export const store = {
  ...
  ].map((s, i) => ({ sensor_id: i+1, area_id: i < 6 ? 1 : 2, sensor_code: s[0], sensor_type: s[1], unit: s[2], mqtt_topic: `greenargric/area/${i < 6 ? 1 : 2}/sensor/${s[0]}/data`, status: 'online', last_seen: iso(-2) })),
  readings: [],
  devices: [
    { device_id: 1, area_id: 1, device_code: 'PUMP-CIRC-A', device_name: 'Máy bơm tuần hoàn A', device_type: 'circulation_pump', status: 'ON', mode: 'AUTO', command_topic: 'greenargric/area/1/device/PUMP-CIRC-A/set', status_topic: 'greenargric/area/1/device/PUMP-CIRC-A/status', last_seen: iso(-1) },
    { device_id: 2, area_id: 1, device_code: 'LED-A', device_name: 'Đèn LED A', device_type: 'grow_light', status: 'OFF', mode: 'AUTO', command_topic: 'greenargric/area/1/device/LED-A/set', status_topic: 'greenargric/area/1/device/LED-A/status', last_seen: iso(-1) },
    { device_id: 3, area_id: 1, device_code: 'FAN-A', device_name: 'Quạt thông gió A', device_type: 'fan', status: 'ON', mode: 'AUTO', command_topic: 'greenargric/area/1/device/FAN-A/set', status_topic: 'greenargric/area/1/device/FAN-A/status', last_seen: iso(-1) },
    { device_id: 4, area_id: 1, device_code: 'DOSING-A', device_name: 'Bơm châm dinh dưỡng A', device_type: 'dosing_pump', status: 'OFF', mode: 'MANUAL', command_topic: 'greenargric/area/1/device/DOSING-A/set', status_topic: 'greenargric/area/1/device/DOSING-A/status', last_seen: iso(-1) },
  ],
  thresholds: [
