...
const broker=process.env.MQTT_BROKER||'mqtt://127.0.0.1:1883';const base=process.env.MQTT_BASE_TOPIC||'greengarden';const area=Number(process.env.AREA_ID||1);const interval=Number(process.env.INTERVAL_MS||5000);
