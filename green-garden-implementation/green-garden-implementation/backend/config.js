...
export const config = {
  ...
  jwtSecret: process.env.JWT_SECRET || 'green_garden_dev_secret_change_me',
  ...
  db: {
    ...
    database: process.env.DB_NAME || 'GreenGarden',
    options: {
  ...
  mqtt: {
    ...
    baseTopic: process.env.MQTT_BASE_TOPIC || 'greengarden',
  },
};
